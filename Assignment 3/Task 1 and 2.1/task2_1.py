...
def main(input_path, test_path, output_path):
...
if __name__ == "__main__":
    ...
    input_path, test_path, output_path,  = sys.argv[1], sys.argv[2], sys.argv[3] 
    #truthfile_path=sys.argv[4]

    sc = SparkContext.getOrCreate()
    start=time.time()
    
    main(input_path, test_path, output_path)
